    ...
    if (token) {
      try {
        const emailData = await sendEmail({
          ...
          text: `Hello, ${user.firstName} ${user.lastName}, please verify you email by clicking this link: https://uni-project-api.onrender.com/api/users/confirmation/${user.id}/${token}`,
        });
